...
public partial class _Default : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("viewFeedBack.aspx?Name=" + Request.QueryString["Name"] + "&userName=" + Request.QueryString["userName"]);
    }
    protected void btnViewStatistics_Click(object sender, EventArgs e)
    {
        Response.Redirect("ChooseStatistics.aspx?Name=" + Request.QueryString["Name"] + "&userName=" + Request.QueryString["userName"]);
    }
}